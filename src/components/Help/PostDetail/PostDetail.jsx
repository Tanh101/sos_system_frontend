...
const PostDetail = ({ close }) => {
    ...
    return (
        <div className='bg-white items-center justify-center text-sm rounded-lg p-3 shadow-lg w-full mx-auto max-w-3xl relative'>
                ...
                <div className="flex justify-between items-center">
                    <div className="flex justify-center items-center">
                        ...
                        <div className="flex flex-col ml-2">
                            <p className="text-lg font-bold">NgocAnh's Post</p>
